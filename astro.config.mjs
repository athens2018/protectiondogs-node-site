  ...
  security: {
    ...
    csp: {
      ...
      directives: [
        ...
        "connect-src 'self' https://formspree.io https://www.google-analytics.com https://region1.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://embed-v2.testimonial.to https://testimonial.to",
        "worker-src 'self'",
        "manifest-src 'self'",
